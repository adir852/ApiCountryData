...
public class DataController {
    ...
    public ResponseEntity<ArrayList<?>> getAllData() throws JsonProcessingException {
        ResponseEntity<String> data = restTemplate.getForEntity("https://data.gov.il/api/action/datastore_search?resource_id=d4901968-dad3-4845-a9b0-a57d027f11ab&limit=" + totalData, String.class);
